    ...
    protected function handleRecordCreation(array $data): Model
{
    ...
    return $quiz;
        ...
        $quizData = [
            ...
            'No of Questions' => $data['manual_question_input'],
    ...
    **Quiz Details:**
    ...
    - **Title**: {$data['title']}
    - **Description**: {$description}
    - **Number of Questions**: {$data['manual_question_input']}
    ...
    **Instructions:**
    ...
    2. **Number of Questions**: Create exactly {$data['manual_question_input']} questions.
    ...
    **Guidelines:**
    - You must generate exactly **{$data['manual_question_input']}** questions.
    ...
    PROMPT;
        ...
        if ($aiType == Quiz::OPEN_AI) {
            ...
            $model = getSetting()->open_ai_model ?? 'gpt-3.5-turbo';
                    ...
                    if (isset($question['question'], $question['answers'])) {
                        ...
                        foreach ($question['answers'] as $answer) {
                            ...
                            Answer::create([
                                ...
                                'answer_type' => $answer['type'] ?? 'text', // Ajout du type dynamique
                            ]);
