...
Repeater::make('manual_questions')
    ->label('Questions manuelles')
    ->schema([
        ...
        Repeater::make('answers')
            ...
            ->schema([
                ...
                TextInput::make('value')
                    ...
                    ->visible(fn(Get $get) => in_array($get('type'), ['text', 'number', 'image', 'audio', 'video', 'document']))
                    ->required(fn(Get $get) => in_array($get('type'), ['text', 'number', 'image', 'audio', 'video', 'document']))
                ...
                Textarea::make('value')
                    ...
                    ->required(fn(Get $get) => $get('type') === 'code'),

                TextInput::make('label')
                    ->label('Nom affiché')
                    ->visible(fn(Get $get) => in_array($get('type'), ['image', 'audio', 'video', 'document']))
                    ->required(fn(Get $get) => in_array($get('type'), ['image', 'audio', 'video', 'document'])),
    ...
    ->addActionLabel('Ajouter une autre question')
    ->columnSpanFull(), 
